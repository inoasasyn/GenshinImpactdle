class Character:
    ...
    def __init__(self, name, rarity, element, weapon_type, model_type, region, special_stat,
                 ascension_local_speciality, ascension_boss_drop, ascension_mob_drop, release_date, version):
        self.name = name
        self.rarity = rarity
